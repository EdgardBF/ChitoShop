                    ...
                    <nav>
                        <div class='nav-wrapper'>
                            ...
                            <ul class='right hide-on-med-and-down'>
                                <li class='"); if($title=="Index"){print("active");}print("'><a href='#' class='color-blanco'>Inicio<i class='material-icons right color-blanco'>home</i></a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                <ul class='side-nav' id='mobile-demo'>
                    <li class='"); if($title="Index"){print("active");}print("'><a href='#' class='color-blanco'>Inicio<i class='material-icons left color-blanco'>home</i></a></li>
                </ul>
            ");
        }
